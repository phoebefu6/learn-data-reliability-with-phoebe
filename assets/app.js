...
(function () {
  ...
  if (crumb && mastheadWrap) {
    var LEADER_PAGES = ["a1-promise-with-a-number.html", "a2-error-budgets.html", "a3-on-call-is-a-design.html", "a4-postmortems.html", "a5-backfills-and-debt.html", "a6-reporting-upward.html"];
    var BUILDER_PAGES = ["b1-slis-for-one-pipeline.html", "b2-slos-from-history.html", "b3-burn-rate-alerts.html", "b4-runbooks.html", "b5-backfills.html", "b6-incident-package.html", "b7-toil.html", "b8-on-call-bench.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:data-reliability";
